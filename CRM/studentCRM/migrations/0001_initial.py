# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-05-22 07:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('LinuxL1', 'Linux中高级'), ('LinuxL2', 'Linux架构师'), ('LinuxL151', 'Linux中高级(51网络)'), ('LinuxL251', 'Linux中高级+架构合成班(51网络)'), ('PythonDevOps', 'Python自动化开发'), ('PythonFullStack', 'Python高级全栈开发'), ('PythonDevOps51', 'Python自动化开发(51网络)'), ('PythonFullStack51', 'Python高级全栈开发(51网络)'), ('BigDataDev', '大数据开发课程'), ('Cloud', '云计算课程')], max_length=128, unique=True, verbose_name='课程名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentCRM.ClassList', verbose_name='班级(课程)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('qq', 'qq群'), ('referral', '内部转介绍'), ('51cto', '52cto'), ('agent', '招生代理'), ('others', '其它')], default='qq', max_length=64, verbose_name='客户来源')),
                ...
                ('class_list', models.ManyToManyField(blank=True, to='studentCRM.ClassList', verbose_name='已报班级')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentCRM.CourseRecord', verbose_name='第几天课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentCRM.Customer', verbose_name='学员')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='school',
            name='staffs',
            field=models.ManyToManyField(blank=True, to='studentCRM.UserProfile'),
        ),
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentCRM.UserProfile', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='customer',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentCRM.Course', verbose_name='咨询课程'),
        ),
        migrations.AddField(
            model_name='customer',
            name='referral_from',
            field=models.ForeignKey(blank=True, help_text='若此客户是转介绍内部学员,请在此处选择内部学员姓名', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='internal_referral', to='studentCRM.Customer', verbose_name='转介绍学员'),
        ),
        migrations.AddField(
            model_name='courserecord',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentCRM.UserProfile', verbose_name='讲师'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentCRM.UserProfile', verbose_name='跟进人'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentCRM.Customer', verbose_name='所咨询的客户'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentCRM.Course'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(to='studentCRM.UserProfile', verbose_name='讲师'),
        ),
